...
export default class Editor extends React.Component {
    ...
    onChange = (evt) => {
        ...
        if(this.props.data.templateContentType == "EMAIL_BODY"){
            ...
            this.props.data.changedContent = evt.editor.getData().replace('<p>','').replace('</p>', '')//evt.editor.document.getBody().getText();
            ...
            <div>
                <div className="col-md-12 col-sm-12 col-xs-12" >
                    {this.state.editMode ?
                        <div className="col-md-10 col-sm-10 col-xs-12">
                            <CKEditor
                                ...
                                config={{
                                    ...
                                    removeButtons: 'PasteText,PasteFromWord,Indent,Outdent,Scayt,Link,Unlink,Anchor,Image,Table,HorizontalRule,SpecialChar,Maximize,Strike,RemoveFormat,NumberedList,BulletedList,Blockquote,Styles,About,Subscript,Superscript'
                        ...
                        :
                        <div className="col-md-10 col-sm-10 col-xs-12" style={previewDivStyle}>
                            <div dangerouslySetInnerHTML={{__html:this.props.data.changedContent}}></div>
                        </div>
                    }
                </div>

                <div className="col-md-12 col-sm-12 col-xs-12">
                        {this.props.data.state && this.props.data.state === 'DRAFT' && this.state.edited === false ?
                            <div>
                                <div className="col-xs-2 pull-right">
                                    <button type="button" className="btn sm btn-primary"
                                            onClick={this.onPublish}>Publish
                                    </button>
                                </div>
                                <div className="col-xs-2 pull-right">
                                    <button type="button" className="btn sm btn-primary"
                                            onClick={this.onReject}>Reject
                                    </button>
                                </div>
                            </div>
                            : null
                        ...
                        {this.state.edited ?
                            <div>
                                <div className="col-xs-2 pull-right">
                                    <button type="button" className="btn sm btn-primary"
                                            onClick={this.onDraft}>Save as Draft
                                    </button>
                                </div>
                                <div className="col-xs-2 pull-right">
                                    <button type="button" className="btn sm btn-primary"
                        ...
                        {this.state.editMode ?
                            <div className="col-xs-2 pull-right">
                                <button type="button" className="btn sm btn-primary"
                                        onClick={this.onPreview}>Preview
                                </button>
                            </div>
                            :
                            <div className="col-xs-2 pull-right">
